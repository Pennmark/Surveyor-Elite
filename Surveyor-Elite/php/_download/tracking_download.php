...
$temp = str_replace("php/_download/tracking_download.php","_library/published/tracer.zip",$_SERVER['PHP_SELF']);
header("Content-disposition: attachment; filename=tracer.zip");
