...
Author: Mark Bazzone
Copyright: 2013
www.surveyorelite.com , surveyorelite.net , surveyorelite.org.
------------------------------------------------------------------------------------------------
************************************************************************************************
------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------
I. REQUIREMENTS.
	A. 	A PHP PLATFORM - WITH php_zip / php_pdo_mysqli extensions enabled
	B. 	SITE MUST DO URL REWRITES - NO FILE EXTENSIONS OR POSTS IN URL OF SURVEY/TEST DISPLAY PAGE
	C. 	A MYSQL DATABASE
	D.	JQUERY 1.7 OR HIGHER LINK MUST BE IN PAGE <HEAD> - Visit Jquery.com for latest link.  You can also download a version to put on your site.
			(IE. Version 1.9 would use <script type="text/javascript" src="http://code.jquery.com/jquery-1.9.1.js" ></script>). 
------------------------------------------------------------------------------------------------
************************************************************************************************
------------------------------------------------------------------------------------------------
II. INSTALLATION.
	***Surveyor Elite Requires Manual Installation.  This application is for Jr.- Sr. level Programmers, Businesses,or anyone who works website internals, understands the responsibility of personal information and tracking, and would be able to use the final XML output.  Manual Installation and XML outputs prevents "anyone" with a site from reaping the benefits of this powerful tool.  This tool is for the Professional and the Professional minded individual or organization.
	--------------------------------------------------------------------------------------------
		A.  EDIT /Surveyor-Elite/js/surveyor-elite_v1.0.0.js AND /Surveyor-Elite/js/surveyor-elite-cms_v1.0.0.js TO WORK ON YOUR PLATFORM.
			...
			---This is very easy!  Surveyor Elite can be placed in any folder, however, it will only be able to locate itself if you set this OBJECT to your local location.
	...
	--------------------------------------------------------------------------------------------
		C.  EDIT  /Surveyor-Elite/php/_config/class._connect.inc.php TO WORK WITH YOUR DATABASE.
			...
			--replace the /*you...name*/ with the appropriate information.
	...
	--------------------------------------------------------------------------------------------
		D.  INSERT DISPLAY ELEMENT INTO DISPLAY PAGE
			...
			---For the Client Side Display: Within the page <BODY> of the front-end page, place the following div element in the page as shown:
				
					<div id="survey-content"></div>  OR  <div id='survey-content'></div>

			--When creating an ADMIN page to place the CMS panel, you must have the word "admin" in the page URL name.  These are all the variations, so you are not limited, and it can be anywhere in the page name (IE my_admin-page, Adminpage, cms-admin)
	...
	--------------------------------------------------------------------------------------------
		E.  INSERT SCRIPT LINK INTO PAGE HEADER
			...
			---In Addition to the Jquery script link, you will need to place a link for surveyor-elite_v1.0.0.js AND surveyor-elite-cms_v1.0.0.js in the <HEAD>.  make sure the path here between the domain and the Surveyor-Elite folder matches the object information you put in INSTALLATION: SECTION A.
